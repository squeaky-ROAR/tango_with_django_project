...
def visitor_cookie_handler(request):
    ...
    # Parse the cookie string back into a datetime object
    # (Trimming the microseconds for easier parsing)
    last_visit_time = datetime.strptime(last_visit_cookie[:-7], '%Y-%m-%d %H:%M:%S')

    # 3. Check if it has been more than a day since the last visit
